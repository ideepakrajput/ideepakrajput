#!/usr/bin/env python3
"""
Create a PDF version of the test paper using HTML with better formatting
"""
...
with open('/workspace/Class_6_Mathematics_Test_Paper_PDF.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print("Enhanced HTML file created successfully!")
print("\nTo convert this to PDF, you have several options:")
print("\n1. Using a web browser (Recommended):")
print("   - Open 'Class_6_Mathematics_Test_Paper_PDF.html' in Chrome/Firefox")
print("   - Press Ctrl+P (or Cmd+P on Mac)")
print("   - Select 'Save as PDF' as the destination")
print("   - Click 'Save'")
print("\n2. Using online converters:")
print("   - Visit https://www.ilovepdf.com/html-to-pdf")
print("   - Upload the HTML file")
print("   - Download the converted PDF")
print("\n3. Using wkhtmltopdf (if installed):")
print("   - Run: wkhtmltopdf Class_6_Mathematics_Test_Paper_PDF.html Class_6_Mathematics_Test_Paper.pdf")